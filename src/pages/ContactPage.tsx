  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 pt-24 pb-10 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-100 max-w-3xl">
            We're here to help! Reach out to us with any questions about our programs, admission process, or campus facilities.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="bg-blue-100 dark:bg-blue-900/40 p-3 rounded-full">
                    <MapPin size={24} className="text-campus-blue dark:text-blue-400" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-blue-100 dark:bg-blue-900/40 p-3 rounded-full">
                    <Phone size={24} className="text-campus-blue dark:text-blue-400" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="bg-blue-100 dark:bg-blue-900/40 p-3 rounded-full">
                    <Mail size={24} className="text-campus-blue dark:text-blue-400" />
                  </div>
                  <div>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
